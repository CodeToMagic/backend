...
import { createMedicineDB, deleteMedicineDB, getAllMedicinesDB, getMedicineByIdBD, updateMedicineDB } from "../db/medicines/medicines";
...
export const getMedicineById =async (req: express.Request, res: express.Response) => {
    try {
        const medicineId = parseInt(req?.params?.medicineId,10);
